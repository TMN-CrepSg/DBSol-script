...
local Window = Rayfield:CreateWindow({
   ...
   ConfigurationSaving = {
      Enabled = true,
      FolderName = "DBSol Hub",
      FileName = "DBSolArsenal"
   },
...
-- visuals
local visualTab = Window:CreateTab("visualTab", "earth")

local VisualsSection = visualTab:CreateSection("wepon Chams")
local WeaponChamsToggle = visualTab:CreateToggle({
...
local playerweaponcolor = visualTab:CreateColorPicker({
    Name = "Weapon Color",
    Color = Color3.fromRGB(255,255,255),
    Flag = "weaponcolor", 
    Callback = function(value)
...
local playerweaponmaterial = visualTab:CreateDropdown({
...
local VisualsSection = visualTab:CreateSection("Visuals")

local LightingToggle = visualTab:CreateToggle({
...
local brightnessrange = visualTab:CreateSlider({
   Name = "Brightness",
   Range = {0, 5},
   Increment = 0.01,
   Suffix = "Brightness",
...
local atmospheredensityrange = visualTab:CreateSlider({
...
local atmosphereoffsetrange = visualTab:CreateSlider({
...
local atmosphereglarerange = visualTab:CreateSlider({
...
local atmospherehazerange = visualTab:CreateSlider({
...
local OutdoorAmbientPicker = visualTab:CreateColorPicker({
...
local AtmosphereColorPicker = visualTab:CreateColorPicker({
...
local AtmosphereDecayPicker = visualTab:CreateColorPicker({
...
-- movement
local MovementTab = Window:CreateTab("Movement", "earth")
local MovementSection = MovementTab:CreateSection("Fly")
...
local FlyRange = MovementTab:CreateSlider({
   Name = "Fly Speed",
   Range = {0, 300},
   Increment = 1,
   Suffix = "Studs",
...
local MovementSection = MovementTab:CreateSection("Noclip")
...
local MovementSection = MovementTab:CreateSection("Speed")
...
local SpeedRange = MovementTab:CreateSlider({
   Name = "Speed",
   Range = {-100, 500},
   Increment = 10,
   Suffix = "Speed",
...
-- Gun mod tab
local GunModsTab = Window:CreateTab("GunMods", "earth")
local GunMods = GunModsTab:CreateSection("Gun Mods")

local GunMods = GunModsTab:CreateSection("Spread + Recoil")

local SpreadToggle = GunModsTab:CreateToggle({
...
local SpreadRange = GunModsTab:CreateSlider({
   Name = "Spread",
   Range = {0, 100},
   Increment = 1,
   Suffix = "Percent",
...
GunModsTab:CreateDivider()

local RecoilToggle = GunModsTab:CreateToggle({
...
local RecoilRange = GunModsTab:CreateSlider({
   Name = "Recoil",
   Range = {0, 100},
   Increment = 1,
   Suffix = "Percent",
...
local GunMods = GunModsTab:CreateSection("fire options")

local FireRateToggle = GunModsTab:CreateToggle({
   Name = "Fast Firerate",
   CurrentValue = false,
   Flag = "fastfirerate",
   Callback = function(value)
...
local InstReloadToggle = GunModsTab:CreateToggle({
   Name = "Instant Reload",
   CurrentValue = false,
   Flag = "instantreload",
   Callback = function(value)
...
local GunMods = GunModsTab:CreateSection("Range")

local IncrRangeToggle = GunModsTab:CreateToggle({
...
local HBSection = GunModsTab:CreateSection("Hitboxes")
local HBToggle = GunModsTab:CreateToggle({
...
local HHBRange = GunModsTab:CreateSlider({
...
local GunMods = GunModsTab:CreateSection("Other")

local InfAmmoToggle = GunModsTab:CreateToggle({
    Name = "Infinite Ammo",
    CurrentValue = false,
    Flag = "infammotoggle",
    Callback = function(value)
...
local AlwaysAutoToggle = GunModsTab:CreateToggle({
